...
from WangLinXMusic.utils.decorators.admins import ActualAdminCB
from WangLinXMusic.utils.decorators.language import language, languageCB
from WangLinXMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from WangLinXMusic.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://envs.sh/nzH.mp4"),
