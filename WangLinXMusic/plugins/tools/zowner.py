...
from WangLinXMusic.mongo.afkdb import LOGGERS as OWNERS
from WangLinXMusic.utils.database import add_served_chat, get_assistant
            ...
            [
                [
                    InlineKeyboardButton(
                        "ƨσʋяcɛ", url=f"https://github.com/WCGKING/WangLinXMusic"
                    )
                ]
            ]
        ),
